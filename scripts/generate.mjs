...
import { STYLE, layers, seasonLayers, crowdLayers, corridorLayers } from './park-layers.mjs';
...
async function main() {
  ...
  const pool = corridor ? corridorLayers : crowd ? crowdLayers : seasons ? seasonLayers : layers;
