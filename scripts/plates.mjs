...
const SCENES = {
  'scene-04': [
    ...
    { id: 'near-bank', variant: 'autumn', raw: 'near-bank-october-v1.png', recipe: 'near-bank' },
    { id: 'near-bank', variant: 'winter', raw: 'near-bank-january-v1.png', recipe: 'near-bank' },
    { id: 'near-bank', variant: 'spring', raw: 'near-bank-april-v1.png', recipe: 'near-bank' },
