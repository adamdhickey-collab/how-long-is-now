    ...
    figures: [
      ...
      // jackets; a man raking at the path's edge does not move.
      {
        ...
        places: [
          ...
          { id: 'leaf-pile', cell: 1, x: 6, z: 7.5, size: 2.4 },
          { id: 'photographer', cell: 3, x: -2, z: 5.8, size: 1.9 },
          { id: 'chair-blanket', cell: 4, x: -10, z: 6.2, size: 1.9 },
          { id: 'pumpkin-family', cell: 5, x: 4, z: 11, size: 2.3 },
          { id: 'hat-dog', cell: 7, x: 10, z: 9.5, size: 2.0 },
        ],
      },
      {
        id: 'movers-autumn',
        ...
        places: [
          ...
          { id: 'cyclist', cell: 2, x: -30, z: 4.6, size: 2.1, speed: 4.2 },
          { id: 'raker', cell: 3, x: -14, z: 5.0 },
          { id: 'coffee-friends', cell: 4, x: 22, z: 4.8, size: 2.1, speed: 1.1 },
          { id: 'kid-bike', cell: 5, x: -8, z: 4.9, size: 1.7, speed: 2.0 },
          { id: 'old-couple', cell: 6, x: 30, z: 4.7, size: 2.1, speed: -0.8 },
          { id: 'stroller-jogger', cell: 7, x: 2, z: 4.8, size: 2.1, speed: 2.2 },
        ],
      },
      ...
      // with an auger crossing the ice, a few on the path in parkas.
      {
        ...
        places: [
          { id: 'ice-house', cell: 0, x: -34, z: -44, size: 4 },
          { id: 'fisherman', cell: 1, x: -12, z: -30 },
          { id: 'snowman', cell: 2, x: 9, z: 6.6, size: 1.9 },
          { id: 'bonfire', cell: 4, x: 24, z: -36, size: 2.6 },
          { id: 'sled', cell: 5, x: -7, z: 7.4, size: 1.6 },
          { id: 'hockey-net', cell: 6, x: 36, z: -26, size: 2.4 },
          { id: 'kneeling-pair', cell: 7, x: 4, z: -18, size: 2.0 },
          { id: 'kneeling-child', cell: 8, x: -22, z: -20, size: 1.6 },
        ],
      },
      {
        id: 'movers-winter',
        ...
        places: [
          ...
          { id: 'skating-couple', cell: 1, x: 20, z: -28, size: 2.1, speed: -1.6 },
          { id: 'hockey-player', cell: 2, x: 34, z: -26, speed: 2.8 },
          { id: 'sled-puller', cell: 3, x: -30, z: -16, size: 2.1, speed: 0.9 },
          ...
          { id: 'fat-bike', cell: 7, x: 26, z: 4.6, size: 2.1, speed: 3.4 },
      ...
      // Late April: the first blankets back, in jackets, and the geese.
      {
        ...
        places: [
          ...
          { id: 'hoodie-man', cell: 1, x: 6, z: 6.2, size: 2.0 },
          { id: 'mother-baby', cell: 2, x: 2, z: 10.8, size: 2.0 },
          { id: 'chair-reader', cell: 4, x: 11, z: 8, size: 1.9 },
          { id: 'goslings', cell: 5, x: -9, z: 5.6, size: 1.6 },
          { id: 'sketchbook', cell: 6, x: 8, z: 11.4, size: 2.0 },
          { id: 'kite-boy', cell: 8, x: -12, z: 9, size: 1.8 },
        ],
      },
      {
        id: 'movers-spring',
        ...
        places: [
          ...
          { id: 'child-bike-parent', cell: 3, x: -30, z: 4.8, size: 2.2, speed: 1.8 },
          { id: 'cyclist', cell: 4, x: 14, z: 4.6, size: 2.1, speed: 4.6 },
          { id: 'umbrella-man', cell: 5, x: -6, z: 4.7, speed: -1.3 },
          { id: 'teens', cell: 6, x: 30, z: 4.8, size: 2.1, speed: 1.0 },
          { id: 'stroller-rain', cell: 7, x: -2, z: 4.9, size: 2.1, speed: -1.1 },
          { id: 'geese-walking', cell: 8, x: -12, z: 5.2, size: 1.2, speed: 0.4 },
        ],
      },
    ],
